...
*/}}
{{- define "hiro-adaptive-orchestrator.name" -}}
...
*/}}
{{- define "hiro-adaptive-orchestrator.fullname" -}}
...
*/}}
{{- define "hiro-adaptive-orchestrator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "hiro-adaptive-orchestrator.resourceName" -}}
{{- $fullname := include "hiro-adaptive-orchestrator.fullname" .context }}
{{- $suffix := .suffix }}
